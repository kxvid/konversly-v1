...
export function ChatWidget() {
  ...
  if (!isOpen) {
    return (
      <Button onClick={() => setIsOpen(true)} className="fixed bottom-4 right-4 size-14 rounded-full shadow-lg">
  ...
  return (
    <Card
      className={cn(
        "fixed bottom-4 right-4 w-[380px] shadow-lg transition-all duration-200 ease-in-out z-50", // Added z-50 for maximum z-index
